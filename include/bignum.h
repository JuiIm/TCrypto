/*
 * bignum.h — Arbitrary-precision integer arithmetic.
 * Numbers are stored as arrays of 32-bit limbs (little-endian).
 * Used for all RSA math (modular exponentiation, prime generation, etc).
 */
#ifndef BIGNUM_H
#define BIGNUM_H
...
/* Serialization: bytes <-> bignum <-> hex */
...
/* Random number generation & primality */
